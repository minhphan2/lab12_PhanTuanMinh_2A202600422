...
from app.ai.tools import search_car, check_promotions, calculate_rolling_price
...
api_key = os.getenv("OPENAI_API_KEY", "dummy-key-to-pass-validation-will-fail-at-runtime")
