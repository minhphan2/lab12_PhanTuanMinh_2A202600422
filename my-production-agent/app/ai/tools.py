...
def check_promotions(condition: str) -> str:
    ...
    sale_md_path = os.path.join(current_dir, "Sale.md")
    try:
    ...
    vinhomes_promo = ""
    import os
    vinhomes_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "vinhomes_promotion.md")
    if os.path.exists(vinhomes_path):
        with open(vinhomes_path, "r", encoding="utf-8") as f:
